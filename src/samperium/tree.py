...
handler = logging.FileHandler("samperium.log")
handler.setFormatter(
    logging.Formatter("%(asctime)s:%(levelname)s:%(name)s: %(message)s")
)
logger.addHandler(handler)

TREE_CHANNEL = 1086797782666465401
TREE_BOT_ID = 972637072991068220
TREE_WEBHOOK_ID = 1086664138144616559

WATER_ID = 1086657105601245325
FRUIT_ID = 1086661676864122990
